...
public class Nucleus extends SchemaImpl {
	...
	private static final long serialVersionUID = 63262876;
	...
	private final List<Table<?>> getTables0() {
		return Arrays.<Table<?>>asList(
			BandaBannedIp.BANDA_BANNED_IP,
			BandaBannedIpRange.BANDA_BANNED_IP_RANGE,
			BandaBannedPlayer.BANDA_BANNED_PLAYER,
			BandaBans.BANDA_BANS,
			BandaPlayerLog.BANDA_PLAYER_LOG,
			BandaProtection.BANDA_PROTECTION);
	}
}
